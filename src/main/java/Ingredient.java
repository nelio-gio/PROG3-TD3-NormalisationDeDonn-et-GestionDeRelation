...
// L'ingrédient est maintenant libre, comme un jouet qui peut être utilisé dans plusieurs jeux (plats), sans être collé à un seul.
public class Ingredient {
    ...
    public String toString() {
        return "Ingredient{id=" + id + ", name='" + name + '\'' + ", category=" + category + ", price=" + price + '}';
    }
}